    ...
    return (
        <div className='w-full'>
            <div className="flex gap-3 justify-around h-full p-4 overflow-x-auto overflow-hidden">
                {
                    trending.map((t, i) =>
                        <Link to={`/${t.media_type}/details/${t.id}`} key={i} className="text-white bg-zinc-900 min-w-[170px] sm:min-w-[220px] overflow-hidden h-[250px] sm:h-[320px]">
                            ...
                            <div className="px-3 mt-1">
                                ...
                                <p className='mt-1 w-[80%] text-sm overflow-y-auto sm:text-base'>{t.overview.slice(0, 80)}... <span className='text-zinc-400'>more.</span></p>
                            </div>
                        </Link>
                    )
                }
