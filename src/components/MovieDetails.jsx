...
const MovieDetails = () => {
  ...
  return info ? (
    <div style={{
      ...
      <nav className='px-5 text-2xl text-zinc-200 w-full h-[7vh] md:h-[10vh] flex gap-10 items-center'>
      ...
      <div className="flex flex-col md:flex-row items-center justify-around mt-3 px-0 lg:px-10">
        ...
        <div className="text-zinc-200 w-[96%] sm:w-[92%] md:w-[60%] mt-3 md:mt-0">
          ...
          <h1 className='mt-2 lg:mt-3 text-1xl font-semibold'>Movie Translated:</h1>
      ...
      <div className="flex flex-col px-3 md:px-20 pt-2 md:pt-5 text-zinc-200">
        ...
        <div className="flex gap-5 items-center mb-2 md:mb-5">
